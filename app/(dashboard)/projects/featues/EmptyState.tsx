...
export default function EmptyState() {
  ...
  <div className="flex flex-col flex-1 h-full items-center justify-center p-6 bg-slate-50">
      ...
      <Link href="/projects/add" className="flex items-center gap-3 bg-(--color-primary) text-white px-8 py-3.5 rounded-xs text-lg font-semibold hover:bg-[#1e3a8a]/90 transition-colors shadow-lg shadow-[#1e3a8a]/20">
