...
import { getEpicTasks } from "../../tasks/action";
...
import EpicDescription from "./EpicModal/EpicDescription";
    ...
    <>
      ...
      >
        <div
          ...
          className="relative w-full h-[80vh] md:h-fit overflow-auto max-w-2xl bg-white rounded-xs shadow-2xl border border-gray-100"
        >
          ...
          <div className="px-10 pb-12">
            <div className="flex justify-between items-center mb-6">
              ...
              <Link href={`/project/${epicData.project_id}/tasks/new`}>
                <button className="text-(--color-primary) font-bold text-sm flex items-center gap-1 hover:underline transition-all cursor-pointer">
            ...
            {/* Empty State Box */}
            <div className="h-[25vh] overflow-auto border-2 border-gray-300 rounded-md">
              {loading ? (
                <Spinner />
              ) : epicTasks.length > 0 ? (
